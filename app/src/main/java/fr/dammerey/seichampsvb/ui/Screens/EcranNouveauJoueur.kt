...
@Composable
fun EcranNouveauJoueur(
    equipeViewModel: EquipeViewModel,
    onClicCreerJoueur:()->Unit,
    onClicAnnulerCreerJoueur:() -> Unit){
        ...
        Column (
            ...
            Card(
                ...
                Column(
                    ...
                    OutlinedTextField(
                        value = equipeViewModel.saisieNumLicence,
                        onValueChange = {input ->
                            if(input.all{it.isDigit()}){
                                equipeViewModel.saisieNumLicence = input
                            }
                            equipeViewModel.erreur = false
                           },
                        label = { Text("Numéro de licence *") },
                        textStyle = typography.titleLarge,
                        isError = equipeViewModel.erreur,
                        keyboardOptions = KeyboardOptions(keyboardType = KeyboardType.Number)
                    )
                    if(equipeViewModel.erreur){
                        Text(
                            text = "Le numéro de licence est obligatoire et ne pourra pas être modifié",
                ...
                Row(
                    ...
                    Button(
                        onClick = {
                            ...
                            equipeViewModel.erreur = equipeViewModel.saisieNumLicence.isBlank()
                            if(!equipeViewModel.erreur){
                                equipeViewModel.AjouterJoueur(joueur,context)
